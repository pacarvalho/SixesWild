...
/**
 * Controller for the time limit setting
 * 
 * @author Katie, Paulo
 *
 */
public class timeLimitController implements ActionListener{
	 ...
	 * @param timeLimitText 
	 */
	public timeLimitController(BuilderPanel builderPanel, BuilderSixesWild builder, SixesWild model, JTextField text){
	...
	public void actionPerformed(ActionEvent e) {
		...
		this.model.getBoard().setTimeLimit(limit);
	}
