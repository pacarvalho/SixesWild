...
/**
 * Controller for move limit in builder
 * 
 * @author katiegandomi, Paulo
 *
 */
public class maxMoveController implements ActionListener{
	 ...
	 * @param timeLimitText 
	 */
	public maxMoveController (BuilderPanel builderPanel, BuilderSixesWild builder, SixesWild model, JTextField text){
	...
	public void actionPerformed(ActionEvent e) {
		...
		this.model.getBoard().setMaxMoves(limit);
	}
}
